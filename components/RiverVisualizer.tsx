...
const RiverVisualizer: React.FC<RiverVisualizerProps> = ({ items, onSelect, filteredRegion }) => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
        // Optional: Can add hover cursor logic here using same picking tech if needed
        // For performance, maybe only check every few frames, or just leave it for click.
        document.body.style.cursor = 'pointer'; // River is always interactive now
    };
